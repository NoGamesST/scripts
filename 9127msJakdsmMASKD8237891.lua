...
if queueonteleport then
	queueonteleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/NoGamesST/scripts/refs/heads/main/9127msJakdsmMASKD8237891.lua',true))()")
end
...
if isfile('plsdonate/'..game.Players.LocalPlayer.Name..'/plsdonatesettings.txt') then
	...
	if er ~= nil then
		...
		--delfile('plsdonate/'..game.Players.LocalPlayer.Name..'/plsdonatesettings.txt')
		task.wait(2)
...
local Window = library:AddWindow("send me death threats @szze .gg/yrQbdfhuqd",
  {
